...
export type IconName =
  ...
  | 'edit' | 'trash' | 'sort' | 'eye' | 'settings' | 'bell' | 'cmd' | 'file'
  | 'archive' | 'map' | 'clock' | 'layers' | 'refresh' | 'qr' | 'tag'
  | 'folder' | 'logout' | 'lock' | 'mail' | 'star' | 'play' | 'pause'
  | 'sparkles' | 'grid' | 'list' | 'calendar' | 'pin'
...
const PATHS: Record<IconName, ReactNode> = {
  ...
  truckIn: <><path d="M3 17V6h12v11" /><path d="M15 9h4l3 4v4h-7" /><circle cx="7" cy="19" r="2" /><circle cx="18" cy="19" r="2" /><path d="M9 8v4" /><path d="M7 10.5l2 1.5 2-1.5" /></>,
  truckOut: <><path d="M3 17V6h12v11" /><path d="M15 9h4l3 4v4h-7" /><circle cx="7" cy="19" r="2" /><circle cx="18" cy="19" r="2" /><path d="M9 12V8" /><path d="M7 9.5l2-1.5 2 1.5" /></>,
