                ...
                <div className="row gap-8" style={{ flexWrap: 'wrap', marginBottom: 8, alignItems: 'flex-start' }}>
                  {imagePreviews.map((src, i) => (
                    ...
                    >
                      ...
                      <button
                        type="button"
                        style={{ position: 'absolute', top: 2, right: 2, background: 'rgba(0,0,0,0.5)', border: 'none', borderRadius: 4, color: '#fff', cursor: 'pointer', lineHeight: 1, padding: '2px 4px', fontSize: 11 }}
