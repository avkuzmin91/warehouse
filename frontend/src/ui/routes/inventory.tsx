...
const InventoryBoxDetailPage = lazy(() =>
  import('../pages/InventoryBoxDetailPage').then((m) => ({ default: m.InventoryBoxDetailPage })),
)
...
export const inventoryRoutes = [
  ...
  <Route key="inventory-boxes-id" path="/inventory/boxes/:boxId" element={<InventoryBoxDetailPage />} />,
