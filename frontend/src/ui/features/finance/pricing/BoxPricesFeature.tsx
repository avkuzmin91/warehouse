...
import { getBoxPricedClients } from '../../../../api/boxPricingApi'
...
import { BoxPriceDrawer } from './BoxPriceDrawer'

const PAGE_SIZE = 25

export function BoxPricesFeature() {
  ...
  return (
    <ListPage
      title="Стоимость короба"
      subtitle={`Цена короба по клиенту · всего ${total}`}
      filters={
        <FiltersBar>
          ...
          <button
            ...
            title="Только клиенты без заведённой цены короба"
          >
    ...
    >
      <Table>
        <thead>
          <tr>
            <th>Клиент</th>
            <th style={{ width: 180, textAlign: 'right' }}>Цена короба</th>
            <th style={{ width: 28 }} />
          </tr>
        </thead>
        <tbody>
