...
def _removed_feature(detail: str) -> None:
    raise HTTPException(
...
@app.api_route(
    "/import/{removed_path:path}",
    methods=["GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS"],
    include_in_schema=False,
)
def removed_import_api(removed_path: str):
    _removed_feature("Excel-импорт отключен")


@app.api_route(
    "/analytics/{removed_path:path}",
    methods=["GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS"],
    include_in_schema=False,
)
def removed_analytics_api(removed_path: str):
    _removed_feature("Аналитика отключена")


@app.api_route(
    "/client-portal/{removed_path:path}",
    methods=["GET", "POST", "PUT", "PATCH", "DELETE", "OPTIONS"],
    include_in_schema=False,
)
def removed_client_portal_api(removed_path: str):
    _removed_feature("Клиентский портал отключен")
